...
範例: The bar chart illustrates the percentage of...
...
範例: YouTube accounted for the highest percentage, at 88%.
...
範例: The figure for Facebook was just under 80%.
...
4. 比較與對比 (替代 "is more than")
    ...
    對比句首: In contrast, / By comparison,
    ...
    相似: Similarly, / Likewise,

範例: The usage rate for YouTube (88%) was more than four times higher than that of LinkedIn (21%).
