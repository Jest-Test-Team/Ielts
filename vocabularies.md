...
1. [🎯 Rank 1: Essential Core Words](#-rank-1-essential-core-words)
2. [🚀 Rank 2: High-Score Advanced Words](#-rank-2-high-score-advanced-words)
3. [⭐ Rank 3: Academic Highlight Words](#-rank-3-academic-highlight-words)
4. [📝 Usage Tips & Learning Strategy](#-usage-tips--learning-strategy)
5. [📊 Vocabulary Statistics](#-vocabulary-statistics)

---

## 🎯 **Rank 1: Essential Core Words**

> **Target:** Master these 150+ words first - they form the skeleton of academic writing
>
> **Impact:** These words will make your articles clear, powerful, and academically sound
>
> **Timeline:** Week 1-2 focus

### **🔥 Core Verbs (核心動詞)**

| Word              | Chinese      | Example Sentence                                                           |
| ----------------- | ------------ | -------------------------------------------------------------------------- |
...
## 🚀 **Rank 2: High-Score Advanced Words**

> **Target:** Use these 200+ words to boost your score from Band 6 to Band 7+
>
> **Impact:** Makes your arguments more precise, specific, and persuasive
>
> **Timeline:** Week 3-4 focus
...
### **⚡ Advanced Adjectives (進階形容詞)**

| Word              | Chinese          | Example Sentence                                 |
| ----------------- | ---------------- | ------------------------------------------------ |
| **resilient**     | 有恢復力的       | **Resilient** systems adapt to change.           |
| **comprehensive** | 全面的           | We need **comprehensive** solutions.             |
...
| **versatile**     | 多才多藝的       | **Versatile** tools serve multiple purposes.     |
...
### **🎯 High-Impact Phrases (高分片語)**

| Phrase               | Chinese            | Example Sentence                                       |
| -------------------- | ------------------ | ------------------------------------------------------ |
...
## ⭐ **Rank 3: Academic Highlight Words**

> **Target:** Use these 150+ sophisticated words to make examiners' eyes light up
>
> **Impact:** Demonstrates advanced academic vocabulary mastery
>
> **Timeline:** Week 5-6 focus (after mastering Ranks 1 & 2)
...
## 📝 **Usage Tips & Learning Strategy**

### **🎯 How to Use These Words Effectively:**

| Principle              | Description                                       | Example                                               |
| ---------------------- | ------------------------------------------------- | ----------------------------------------------------- |
| **Context Matters**    | Choose words that fit naturally in your sentence  | Use "mitigate" for reducing problems, not "eliminate" |
| **Don't Overuse**      | Variety is better than repetition                 | Mix simple and advanced vocabulary                    |
| **Practice Regularly** | Use these words in your writing practice          | Write 3 sentences daily with new words                |
| **Check Collocations** | Some words work better with certain prepositions  | "contribute TO" not "contribute FOR"                  |
| **Start with Rank 1**  | Master the basics before moving to advanced words | Foundation first, then build up                       |

### **📅 Learning Timeline:**

| Week         | Focus                               | Goal                            | Daily Practice      |
| ------------ | ----------------------------------- | ------------------------------- | ------------------- |
| **Week 1-2** | Rank 1 words (core vocabulary)      | Master 150+ foundation words    | 10 new words/day    |
| **Week 3-4** | Rank 2 words (advanced vocabulary)  | Add 200+ advanced words         | 15 new words/day    |
| **Week 5-6** | Rank 3 words (academic highlights)  | Incorporate 150+ academic words | 10 new words/day    |
| **Ongoing**  | Practice using all words in context | Maintain and improve            | Review 20 words/day |

### **🎓 Study Methods:**

1. **Flashcard System:** Create digital flashcards with word, meaning, and example
2. **Sentence Creation:** Write 3 original sentences for each new word
3. **Essay Integration:** Use 5-10 new words in each practice essay
4. **Collocation Practice:** Learn common word partnerships
5. **Regular Review:** Revisit words weekly to maintain retention
...
| **Verbs**      | 20     | 20     | 10     | 50      |
| **Nouns**      | 20     | 20     | 10     | 50      |
| **Adjectives** | 20     | 20     | 10     | 50      |
| **Phrases**    | 5      | 5      | 5      | 15      |
| **Total**      | **65** | **65** | **35** | **165** |

### **🎯 Target Band Scores:**

- **Band 6.0:** Master 80% of Rank 1 words
- **Band 7.0:** Master 90% of Rank 1 + 60% of Rank 2 words
- **Band 8.0:** Master 95% of Rank 1 + 80% of Rank 2 + 40% of Rank 3 words
- **Band 9.0:** Master 100% of all ranks with perfect usage

### **💡 Pro Tips for IELTS Success:**

1. **Quality over Quantity:** Better to use common words correctly than advanced words incorrectly
2. **Natural Integration:** Don't force advanced vocabulary - use it when it fits naturally
3. **Collocation Awareness:** Learn how words combine with others (e.g., "make progress" not "do progress")
4. **Context Sensitivity:** Choose vocabulary appropriate to the topic and tone
5. **Consistent Practice:** Daily vocabulary practice is more effective than cramming

---

_Remember: Vocabulary is the foundation of good writing. Practice using these words in context to improve your IELTS performance systematically and effectively!_ 🚀✨

---

Session Score: 16 / 20 (80%)
Mistakes in this session:

    Question: "Correct: fleshing"
    Your answer: flashing
    Correct answer: fresh
    Question: "Correct: full with jagors"
    Your answer: full with jargon
    Correct answer: full of jargon
    Question: "農業 (單數)"
    Your answer: argriculture
    Correct answer: agriculture
    Question: "Correct: woking"
    Your answer: wotking
    Correct answer: working
    Question: "users... [?] for the majority. (active verb)（組成）"
    Your answer: constructed
    Correct answer: accounted
    Question: "the reason... [?] due to... (verb)"
    Your answer: of
    Correct answer: was
    ...
    Question: "企業 (複數)"
    Your answer: coporations
    Correct answer: corporations
    Question: "企業 (複數)"
    Your answer: copoarations
    Correct answer: corporations
