...
## Final sprint
今日 (9/29 週一)	下午	GitHub巡禮與寫作品質維持	1. (60-90分鐘): 仔細複習您GitHub上的寫作錯誤筆記 (例如 sentence_control_log.md 和 common_errors.md)。 2. (60分鐘): 只寫一篇Task 2，不計時，目標是應用所有學過的技巧，寫一篇完美的範文來鼓舞自己。
	晚上	口說練習鞏固	根據您整理的 04_Speaking/index.md，進行主題式口說練習。
明日 (9/30 週二)	19:30-21:00	主動式複習 (聽力與閱讀)	GitHub巡禮: 專注於複習您的聽力和閱讀錯題本 (01_Listening/error_log.md 和 02_Reading/error_log.md)。不做新題。
後天 (10/1 週三)	19:30-21:00	主動式複習 (寫作與口說)	GitHub巡禮: 再次瀏覽您最高分的幾篇作文，並複習口說的加分片語。
